...
#include "olimex_mod_mpu6050_inotify.h"
...
class Olimex_Mod_MPU6050_EventHandler
 : public Olimex_Mod_MPU6050_INotify<Olimex_Mod_MPU6050_Message>
{
 public:
  Olimex_Mod_MPU6050_EventHandler (Olimex_Mod_MPU6050_GtkCBData_t*); // Gtk state
  virtual ~Olimex_Mod_MPU6050_EventHandler ();

  // implement Olimex_Mod_MPU6050_INotify_t
  virtual void start ();
  virtual void notify (Olimex_Mod_MPU6050_Message*); // data
  virtual void end ();

 private:
  typedef Olimex_Mod_MPU6050_INotify<Olimex_Mod_MPU6050_Message> inherited;
